...
# ───────────────────────────────────────────────────────────────────────────────
# GDPR info banner (už má lang_choice definovaný)
# ───────────────────────────────────────────────────────────────────────────────
...
# ───────────────────────────────────────────────────────────────────────────────
# (ďalšie časti tvojho kódu – krajiny, kategórie, CNB, IssueCoin, form, export…)
# nechávajú sa bezo zmeny – všetko pod týmto riadkom môžeš ponechať
# ───────────────────────────────────────────────────────────────────────────────
# CATEGORIES (SK/CZ + EN)
# ───────────────────────────────────────────────────────────────────────────────
CATEGORIES = {
...
def get_holiday_name(date_obj: dt_date, iso2: str, lang: str):
    ...
    try:
        ...
        # Ak je jazyk slovenský alebo český → použijeme preklad (ak existuje)
        if lang in ["sk", "cz"]:
